...
```
+-------------+-------------+-------------+-------------+-------------+
| Name        | Description | Example     | Status      | Implement?   
+=============+=============+=============+=============+=============+
| A-IM        | Acceptable  | `A-IM: feed | Permanent   |  
|             | instance-ma | `           |             |         
|             | nipulations |             |             |  
|             | for the     |             |             |       
|             | request.[^1 |             |             |         
|             | 0]          |             |             |             
+-------------+-------------+-------------+-------------+-------------+
| Accept      | [Media      | `Accept: te | Permanent   | 
|             | type(s)](Me | xt/html`    |             | 
|             | dia_type "w |             |             | 
|             | ikilink")   |             |             |  
|             | that is/are |             |             |          
...
|             |             |             |             | 
+-------------+-------------+-------------+-------------+-------------+
| Accept-Date | Acceptable  | `Accept-Dat | Provisional | 
| time        | version in  | etime: Thu, |             | 
|             | time.       |  31 May 200 |             | 
|             |             | 7 20:35:00  |             | 
|             |             | GMT`        |             | 
+-------------+-------------+-------------+-------------+-------------+
| Accept-Enco | List of     | `Accept-Enc | Permanent   | 
| ding        | acceptable  | oding: gzip |             | 
|             | encodings.  | , deflate`  |             | 
|             | See [HTTP   |             |             | 
|             | compression |             |             | 
|             | ](HTTP_comp |             |             |             
...
|             | kilink").   |             |             |             
+-------------+-------------+-------------+-------------+-------------+
| Accept-Lang | List of     | `Accept-Lan | Permanent   | 
| uage        | acceptable  | guage: en-U |             | 
|             | human       | S`          |             | 
|             | languages   |             |             | 
|             | for         |             |             | 
|             | response.   |             |             |             
...
|             | chain.      |             |             |             
+-------------+-------------+-------------+-------------+-------------+
| Connection  | Control     | url=<http:/ | title=Hyper | 
|             | options for | /tools.ietf | text        | 
|             | the current | .org/html/r | Transfer    | 
...
|             | the client. |             |             |             
+-------------+-------------+-------------+-------------+-------------+
| Forwarded   | Disclose    | url=<http:/ | title=Forwa | 
|             | original    | /tools.ietf | rded        | 
|             | information | .org/html/r | HTTP        | 
...
|             | request.    |             |             |             
+-------------+-------------+-------------+-------------+-------------+
| Host        | The domain  | url=<http:/ | title=Hyper | 
|             | name of the | /tools.ietf | text        | 
|             | server (for | .org/html/r | Transfer    | 
